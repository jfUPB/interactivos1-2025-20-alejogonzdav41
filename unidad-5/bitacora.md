...
El micro:bit se conecta con el computador por el puerto serial y manda datos a una velocidad de 115200 baudios. Lo que hace es medir con su acelerómetro los valores en los ejes X y Y, y también leer si los botones A y B están oprimidos o no.

**¿Cómo es la estructura del protocolo ASCII usado?**

El protocolo es muy sencillo porque usa texto plano. Cada paquete tiene cuatro valores separados por comas y termina con un salto de línea *\n*.
